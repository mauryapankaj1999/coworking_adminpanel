...
import {
  useWorkspaceCreateCategory,
  useWorkspaceCategory,
  useWorkspaceUpdateCategory,
} from "../../../hooks/useWorkspaceCategory";
...
export default function AddWorkspaceCategory() {
  ...
  const { data: categoryData } = useWorkspaceCategory(id);

  const { mutateAsync: createCategory, isPending } = useWorkspaceCreateCategory();
